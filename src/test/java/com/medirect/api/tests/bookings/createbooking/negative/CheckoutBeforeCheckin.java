...
public class CheckoutBeforeCheckin extends BaseTest {
    ...
    @Test()
    @Story("Checkout Before Checkin")
    @Description("Checkin should be before Checkout")
    @Severity(SeverityLevel.CRITICAL)
    @ValidateResponse(statusCode = 400, contentType = ContentType.TEXT, maxResponseTime = 200)
    public void testCheckoutBeforeCheckin(ITestContext context) {
