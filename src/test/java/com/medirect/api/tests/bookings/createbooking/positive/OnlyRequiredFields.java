...
public class OnlyRequiredFields extends BaseTest {
    ...
    @Test()
    @Story("Create new booking with Only required fields")
    @Description("Test to validate successful creation of a booking with Only required fields")
    @Severity(SeverityLevel.MINOR)
    @ValidateResponse(statusCode = 200, contentType = ContentType.JSON, maxResponseTime = 1000)
    public void testOnlyRequiredFields(ITestContext context) {
