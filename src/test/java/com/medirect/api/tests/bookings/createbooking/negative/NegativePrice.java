...
public class NegativePrice extends BaseTest {
    ...
    private static BookingDto generateBooking() {
        return BookingDto.builder()
                ...
                .totalprice(Utils.randomInt(-100, -10))
    ...
    @Test()
    @Story("Negative Price")
    @Description("Total Price should be greater than 0")
    @Severity(SeverityLevel.NORMAL)
    @ValidateResponse(statusCode = 400, contentType = ContentType.TEXT, maxResponseTime = 200)
    public void testNegativePrice(ITestContext context) {
